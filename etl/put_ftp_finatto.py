...
con = cx_Oracle.connect(user="dwu",password="09xbe4389dwu22", dsn="finatto",encoding="UTF-8")
cur = con.cursor()

import os
for file in os.listdir("/home/finatto"):
    if  file.endswith(".txt"):
        nome = str(file)
        file = open("/home/finatto/"+file, "r") 
